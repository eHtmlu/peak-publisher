<?php
namespace Pblsh\Vendor\WordPressdotorg\Plugin_Directory;
defined('ABSPATH') || exit;

if ( ! class_exists( '\Pblsh\Vendor\Michelf\MarkdownExtra' ) ) {
 ...
 */
class Markdown extends \Pblsh\Vendor\Michelf\MarkdownExtra {
