...
// The code below is just the bootstrap code intended to be inserted into the hosted plugins.
// Do not remove this exit statement because this file is NOT intended to be executed in this context.
exit;
