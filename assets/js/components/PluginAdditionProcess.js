...
lodash.set(window, 'Pblsh.Components.PluginAdditionProcess', ({ onCreated } = {}) => {
    ...
    const steps = [
        { id: 1, label: __('Header', 'publisher'), description: __('Add required plugin headers', 'publisher') },
        { id: 2, label: __('Code', 'publisher'), description: __('Add the required bootstrap code', 'publisher') },
        { id: 3, label: __('Upload', 'publisher'), description: __('Upload to Publisher', 'publisher') },
    ];
    ...
    const renderStepper = () => {
        return createElement('div', { className: 'pblsh--stepper', role: 'navigation', 'aria-label': __('Setup steps', 'publisher'), style: { '--steps': steps.length, '--step': step } },
    ...
    const renderHeaderTips = () => {
        ...
        return [
            createElement('h3', { className: 'pblsh--card__title' }, __('Required and recommended headers', 'publisher')),
            createElement('p',
                null,
                __('The "Plugin Name," "Version," and "Update URI" headers are required. However, all other headers below are also highly recommended. Adjust the values ​​according to your individual needs.', 'publisher'),
                ' ',
                __('A full list of headers can be found in the WordPress Documentation: ', 'publisher'),
            ...
            createElement('div', { className: 'pblsh--snippet-wrapper' },
                createElement('div', { className: 'pblsh--snippet-toolbar' },
                    createElement('button', {
                        ...
                        'aria-label': __('Copy example header', 'publisher'),
                    }, __('Copy', 'publisher')),
                ),
            ...
            createElement('h3', null, __('3 facts about version numbers', 'publisher')),
            createElement('ul', { className: 'pblsh--ul' },
                createElement('li', null, __('A plugin is never finished, so dare to name the first version of your plugin what it is → 1.0.0', 'publisher')),
                createElement('li', null, __('A good and very common version number convention is the format "X.X.X" (major.minor.patch). Read more about it here: ', 'publisher'), createElement('a', { href: 'https://semver.org/', target: '_blank' }, 'https://semver.org/')),
                createElement('li', null, __('Each integer part of the version number increments independently and can have more than one digit. So feel free to increment 1.9.0 to 1.10.0.', 'publisher')),
            ),
        ];
    };
        ...
        if (step === 1) {
            return createElement('div', { className: 'pblsh--step' },
                createElement('div', { className: 'pblsh--card' },
                    createElement('h3', { className: 'pblsh--card__title' }, __('Add this line to your plugin header', 'publisher')),
                    createElement('p', null, __('This is the API endpoint that your plugin will use to check for updates.', 'publisher')),
                    PblshData.bootstrapUpdateURI.match(/^http\:\/\//) && createElement('div', { className: 'pblsh--addition-process--protocol-warning' }, createElement('strong', null, __('WARNING: Your WordPress site is using an insecure connection. We strongly recommend switching to HTTPS before copying and using this update URI.', 'publisher'))),
                    createElement('div', { className: 'pblsh--snippet-wrapper' },
                        createElement('div', { className: 'pblsh--snippet-toolbar' },
                            createElement('button', {
                                type: 'button',
                                ...
                                'aria-label': __('Copy Update URI', 'publisher'),
                            }, __('Copy', 'publisher')),
                        ),
                        createElement('pre', null,
                    ...
                    createElement('div', { className: 'pblsh--snippet-wrapper' },
                        createElement('div', { className: 'pblsh--snippet-toolbar' },
                            createElement('button', {
                                ...
                                'aria-label': __('Copy bootstrap code', 'publisher'),
                            }, __('Copy', 'publisher')),
                        ),
                        createElement('pre', null,
        ...
        if (step === 3) {
            return createElement('div', { className: 'pblsh--step' },
                createElement('div', { className: 'pblsh--card pblsh--card--upload-zip' },
                    createElement('div', null,
                        createElement('h3', { className: 'pblsh--card__title' }, __('Upload your plugin', 'publisher')),
                    ),
                    createElement('div', {
                        ...
                        'aria-label': __('Drop plugin or click to select', 'publisher'),
                    },
                        createElement('div', { className: 'pblsh--dropzone__inner' },
                            ...
                            createElement('div', { className: 'pblsh--dropzone__text' }, __('Drop plugin or click to select', 'publisher')),
                            createElement('div', { className: 'pblsh--dropzone__desc' },
                                createElement('p', null, __('You can drop:', 'publisher')),
                                createElement('ul', { className: 'pblsh--ul' },
                                    createElement('li', null, __('a zip file', 'publisher')),
                                    createElement('li', null, __('a plugin folder', 'publisher')),
                                    createElement('li', null, __('files of a plugin folder', 'publisher')),
                                ),
                            ),
                        ),
                    ),
