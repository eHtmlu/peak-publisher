<?php
namespace Pblsh\Vendor\WordPressdotorg\Plugin_Directory\Readme;
defined('ABSPATH') || exit;

use Pblsh\Vendor\WordPressdotorg\Plugin_Directory\Markdown;
...
class Parser {
	...
	protected function parse_markdown( $text ) {
		...
		if ( ! class_exists( '\Pblsh\Vendor\WordPressdotorg\Plugin_Directory\Markdown' ) ) {
			return $text;
		}
